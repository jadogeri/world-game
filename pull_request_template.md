...
- [ ] If `lib/api-spec/openapi.yaml` changed, ran `pnpm --filter @workspace/api-spec run codegen` and committed the generated output
- [ ] If `lib/db` schema changed, ran `pnpm --filter @workspace/db run push` (dev) and documented the change
